...
import { Section, Container, Wrapper, DescriptionWrapper, DescriptionNumber, DescriptionTitle, DescriptionParagraph, FrameWrapper, Spacer } from "./styled";
            ...
            <Container>
                ...
                <Wrapper>
                    ...
                    <DescriptionWrapper>
                        ...
                        <DescriptionParagraph>{information2.paragraph3}</DescriptionParagraph>
                    </DescriptionWrapper>
                </Wrapper>
            </Container>
        </Section>
